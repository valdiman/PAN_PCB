...
The scripts included here are part of the study XXX
...
Subjects: polychlorinated biphenyls; air; water; sediment; sampling rate; GC-MS/MS; novel passive sampling material
...
It is recommended to create a project in R (e.g., PAN_PCB.Rproj).
